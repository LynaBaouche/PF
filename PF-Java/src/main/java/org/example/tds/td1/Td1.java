...
public class Td1 {
    ...
    public static void main(String[] args) {
        ...
        //
        BiFunction<Predicate<String>, List<Information>, List<Information>> messageSelecteur = selection(Information::message);
        BiFunction<Predicate<List<String>>, List<Information>, List<Information>> tagsSelecteur = selection(Information::tags);
        BiFunction<Predicate<String>, List<Information>, List<Information>> countrySelecteur = selection(Information::country);
        BiFunction<Predicate<LocalDateTime>, List<Information>, List<Information>> timestampSelecteur = selection(Information::timestamp);
        //
